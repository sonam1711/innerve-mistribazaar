...
export const aiAPI = {
  ...
  generate3DHouse: (data: any) => api.post('/ai/3d-house/generate/', data),
  download3DHouseScript: (filename: string) => api.get(`/ai/3d-house/download/${filename}/`, { responseType: 'blob' }),
}
